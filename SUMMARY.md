...
## 1) Key Properties <a href="#key-properties" id="key-properties"></a>
...
## 2) The Engine <a href="#engine" id="engine"></a>

* [2.1 Consensus](engine/2.1-consensus.md)
* [2.2 Protocols](engine/2.2-protocols.md)

## 3) Architecture <a href="#architecture" id="architecture"></a>

* [3.1 Overview](architecture/3.1-overview.md)
* [3.2 Hadron](architecture/3.2-hadron.md)
* [3.3 Fornax](architecture/3.3-fornax.md)
* [3.4 Castor](architecture/3.4-castor.md)
* [3.5 LynxChains](architecture/3.5-lynxchains.md)
* [3.6 Orion](architecture/3.6-orion.md)
* [3.7 Bootstrapping](architecture/3.7-bootstrapping.md)
* [3.8 Sybil Control & Membership](architecture/3.8-sybil-control-and-membership.md)
* [3.9 Smart Contracts](architecture/3.9-smart-contracts.md)

## 4) Initium Cluster <a href="#cluster" id="cluster"></a>
...
## 5) Governance <a href="#gov" id="gov"></a>

* [5.1 $INIX Token](gov/inix.md)
* [5.2 Governance](gov/5.2-governance.md)

## 6) Discussion <a href="#discussion" id="discussion"></a>
